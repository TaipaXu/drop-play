...
Drop Play 是一个轻量的本地视频播放器。把视频文件拖进页面或通过文件选择器打开即可播放，也可以一次添加多个文件形成播放列表。项目面向“无需上传、无需后端、打开即用”的本地观看场景。

## 界面预览

![Drop Play 界面](./app.zh-CN.png)

## 功能特性

- 拖拽或选择视频文件直接播放，支持一次添加多个文件。
...
在浏览器和键盘支持时，也可以使用兼容的硬件媒体键控制播放、暂停、停止以及切换上一项或下一项。
